...
INSERT INTO Clientes ([id_cliente], [PrimerNom_cli], [SegundoNom_cli], [PrimerApp_cli], [SegundoApp_cli], [dir_cli], [tel_cli], [correo_elect], [Nombre_empresa], [Ruc]) VALUES ('1751360799', N'Jean', N'Carlos', N'Alcivar', N'Mendez', N'La Ecuatoriana', N'0978514041', N'jeanxd20@gmail.com', N'San Martín', N'192889086019');
...
INSERT INTO Empleados ([id_empleado], [PrimerNom_cli], [SegundoNom_cli], [PrimerApp_cli], [SegundoApp_cli], [dir_cli], [tel_cli],  [rol], [correo], [ocupacion], [clave], [nomb_usuario], [nombreSede], [sueldo]) VALUES  ('1784505982', N'Erik', N'Alexander', N'Armijos', N'Saldaña', N'Martha Bucaram', N'0989797745', N'Administrador', N'erikarmijos@gmail.com',N'Vigilador', N'erik12345', N'erik21', N'Quito', CAST(480.00 AS Decimal(9, 2)));
...
INSERT INTO Productos ([id_producto], [nombre_prod], [precio_porPaq], [cant]) VALUES (45343, N'Goma líquida', CAST(4.00 AS Decimal(7, 2)), 188);
...
INSERT INTO Productos ([id_producto], [nombre_prod], [precio_porPaq], [cant]) VALUES (12328, N'Marcadores de tiza liquída', CAST(9.00 AS Decimal(7, 2)),111);
...
INSERT INTO Proveedores ([id_proveedor], [nombre_prov], [correo_elect], [tel_prov], [dir_prov], [nombreSede]) VALUES (N'2892837626732', N'Grupo 100', N'grupo100@gmail.com', N'0932000489', N'Las Peñas', N'Quito');
...
BEGIN
    SELECT
        noc.num_orden AS 'Código de Compra',
        p.nombre_prod AS 'Nombre del Producto',
        ic.id_producto AS 'Código de Barra',
...
BEGIN
    SELECT
        fv.num_factura AS 'Código de Venta',
        fv.id_cliente AS 'Cedula del Cliente',
        p.nombre_prod AS 'Nombre del Producto',
        iv.id_producto AS 'Código de Barra',
